...
export default defineConfig({
  ...
  testMatch: ['**/vault-logging.spec.ts', '**/vault-checkin-manual.spec.ts', '**/vault-i18n-voice.spec.ts', '**/ctx-voiceover.spec.ts', '**/prehab.spec.ts', '**/smart-cardio.spec.ts', '**/smart-cardio-generator.spec.ts', '**/sports-hub.spec.ts', '**/champion-mindset-visual.spec.ts', '**/content-manager.spec.ts'],
  fullyParallel: true,
