...
const VOICE_ID_EN = 'EXAVITQu4EsNIXwXEa7H'; // Julius (male, fitness coaching)
const VOICE_ID_ES = 'EXAVITQu4EsNIXwXEa7H'; // Same voice for consistency
const VOICE_ID_PT = 'EXAVITQu4EsNIXwXEa7H'; // Same voice for consistency
