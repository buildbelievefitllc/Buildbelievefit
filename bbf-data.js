...
// ─── PREHAB DATA ─────────────────────────────────────────────────
var DAILY_EN = '&#x1F305; Morning (3 min): Cat-cow x10, glute bridge x15, ankle circles x10 each.<br>&#x1F3CB; Pre-Workout (2 min): Wall slides x10, 90/90 hip x30s each side.<br>&#x1F634; Post-Shift (5 min): Child's pose 60s, prayer stretch 30s, single-leg balance 30s each.<br>&#x26A1; Weekly: Add band external rotation on upper-body days. Non-negotiable.';
    ...
    cues: [
      {
        ...
        en_txt: 'Stand with back flat against wall. Press forearms and wrists to the wall. Slide arms overhead slowly — keep contact the whole way. If you lose contact, that's your mobility limit. Work to that point, not through it.',
...
var RECOVERY_CUES = {
  ...
  standing: {
    ...
    cues: [
      { title:'Lumbar Decompression', desc:'Concrete floors load your spine for hours. Child's pose 60s + cat-cow 10 reps post-shift before anything else. This is maintenance, not a warmup.' },
  ...
  mixed: {
    ...
    cues: [
      ...
      { title:'Deload Recognition', desc:'When your motivation crashes AND performance drops together — that's overreaching, not laziness. Take a deload week before it becomes forced rest.' }
    ]
  }
};
