...
export const TIER_TO_GROUP = {
  ...
  // ── Blueprint band — standalone lean tracker. Micro-sub SKUs (basic/pro) + legacy slug; all one access profile, differing only in monthly token allotment (server-side). ──
...
export const FEATURE_UPGRADE_PATH = {
  ...
  nutrition_fueling_status: 'nutrition', // Fuel Performance
  nutrition_periodization: 'nutrition', // Fuel Sovereign
  sports_hub: 'youth',
  roster: 'youth',
