...
const DICT = {
  ...
  'f-health-q': { en: 'PAR-Q+ Health Screening', es: 'Evaluación de Salud PAR-Q+', pt: 'Avaliação de Saúde PAR-Q+' },
  'f-parq1': { en: 'Has a doctor ever said you have a heart condition?', es: '¿Alguna vez un médico le dijo que tiene una condición cardíaca?', pt: 'Algum médico já disse que você tem uma condição cardíaca?' },
  'f-parq2': { en: 'Do you feel pain in your chest during physical activity?', es: '¿Siente dolor en el pecho durante la actividad física?', pt: 'Você sente dor no peito durante a atividade física?' },
  'f-liability': { en: 'I confirm I am physically able to participate and release BBF from liability for injuries sustained during training.', es: 'Confirmo que estoy físicamente apto para participar y libero a BBF de responsabilidad por lesiones sufridas durante el entrenamiento.', pt: 'Confirmo que estou fisicamente apto para participar e isento a BBF de responsabilidade por lesões sofridas durante o treino.' },
  'f-terms': { en: 'I agree to the Terms of Service and Privacy Policy.', es: 'Acepto los Términos de Servicio y la Política de Privacidad.', pt: 'Concordo com os Termos de Serviço e a Política de Privacidade.' },
