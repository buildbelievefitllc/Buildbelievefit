...
const DICT = {
  ...
  // ── Vanguard Blueprint Override — "Skip Calibration" pricing breakout (micro-subs) ──
  'bp-toggle': { en: 'Seasoned Veteran? Skip Calibration.', es: '¿Veterano Experimentado? Omite la Calibración.', pt: 'Veterano Experiente? Pule a Calibração.' },
  'bp-head': { en: 'Vanguard Blueprint Override', es: 'Anulación Vanguard Blueprint', pt: 'Substituição Vanguard Blueprint' },
  'bp-msg': {
    ...
    es: 'La mayoría de las apps de fitness te lanzan 500 ejercicios el primer día. En BBF Lab no adivinamos, diseñamos. El ingreso normalmente requiere una calibración biométrica obligatoria de 30 días para mapear la fricción articular. Sin embargo, si eres un veterano experimentado que requiere una ejecución manual impecable sin capas de coaching continuo, estás autorizado para el despliegue inmediato al Vault.',
    pt: 'A maioria dos apps de fitness despeja 500 exercícios no primeiro dia. Na BBF Lab não adivinhamos, engenheiramos. O ingresso normalmente exige uma calibração biométrica obrigatória de 30 dias para mapear o atrito articular. No entanto, se você é um veterano experiente que exige execução manual impecável sem camadas de coaching contínuo, está liberado para o deployment imediato no Vault.',
  },
  'bp-billing': { en: 'Billed monthly · cancel anytime', es: 'Facturado mensualmente · cancela cuando quieras', pt: 'Cobrado mensalmente · cancele quando quiser' },
  'bp-basic-name': { en: 'Basic Blueprint', es: 'Basic Blueprint', pt: 'Basic Blueprint' },
  'bp-basic-feat': { en: '1 Master Program Generation Token per billing period.', es: '1 Token de Generación de Programa Maestro por período de facturación.', pt: '1 Token de Geração de Programa Mestre por período de cobrança.' },
  'bp-pro-name': { en: 'Pro Blueprint', es: 'Pro Blueprint', pt: 'Pro Blueprint' },
  'bp-pro-feat': { en: '3 Master Program Generation Tokens per billing period.', es: '3 Tokens de Generación de Programa Maestro por período de facturación.', pt: '3 Tokens de Geração de Programa Mestre por período de cobrança.' },
  'bp-cta': { en: 'Get Started →', es: 'Comenzar →', pt: 'Começar →' },
