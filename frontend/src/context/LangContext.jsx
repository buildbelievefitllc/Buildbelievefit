...
const DICT = {
  ...
  'vh-blueprint-k': { en: 'Sovereign Vault Daily Blueprint', es: 'Plan Diario de la Bóveda Soberana', pt: 'Plano Diário do Cofre Soberano' },
  ...
  'vh-ex-count': {
    en: 'exercises prescribed today — open Program to execute.',
    es: 'ejercicios prescritos hoy — abre Programa para ejecutar.',
    pt: 'exercícios prescritos hoje — abra Programa para executar.',
  },
