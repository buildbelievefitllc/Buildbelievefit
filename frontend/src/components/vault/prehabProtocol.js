...
export const EX_VIDEO = {
  // ── Lower Back ──────────────────────────────────────────────────────────
  mckenzie_press_up: { en: 'gLT-WLH84B4', es: 'oT4yB8jfNsA', pt: 'nRDqWU_EqE4' },         // prone spinal extension (Back Extension)
  bird_dog: { en: 'ZdAHe9_HeEw', es: 'tVTEZeHmsZ8', pt: 'XajwAH3Ja3A' },
  ...
  pelvic_tilt: { en: 'Q59R9p4rzxw', es: 'x4b4V86e4XM', pt: 'YFz1c5xsOYE' },               // Supine Posterior Pelvic Tilt (MedBridge)
  knee_to_chest: { en: 'Yd9wY25koVk', es: 'af7t-SnWzyQ', pt: 'L7mcmARAoqw' },             // Single Knee to Chest (AskDoctorJo)
  supine_lumbar_rotation: { en: 'fHRXXGxUxX8', es: 'WLssvI6fheg', pt: 'rN-5JdBzBuA' },    // Supine Lower Trunk Rotation (MedBridge)
  half_kneeling_hip_flexor: { en: 'mzPvzMivukw', es: '8xZlzcMAtVQ', pt: 'A751ZTAwCLw' },  // Half-Kneeling Hip Flexor Stretch (HSS)
  side_plank: { en: 'Ujf5ELfqI7o', es: 'pDyEQGVVH_M', pt: 'zt7PjySXWCw' },                // Side Plank (VIDEO_MAP)
  // ── Knee ────────────────────────────────────────────────────────────────
  tempo_goblet_squat: { en: 'BR4tlEE_A98', es: '5HHITKuLxUs', pt: 'ge1vdJRP0UA' },
  terminal_knee_ext: { en: 'tTbJBUKnWU8', es: 'o-x_Svr3wK8', pt: 'pMOMsPuTgr8' },         // Leg Extension (VMO bias)
  ...
  eccentric_step_down: { en: 'Ig_Qo-GKjRc', es: 'X0QRvoKJEkc', pt: 'NQweG8cA_A0' },       // Eccentric Step-Down for knee pain
  lateral_band_walk: { en: 'y_bqFDQZSHQ', es: 'TvP6iLcGNP0', pt: 'e2SJvb2Ujzc' },         // Lateral Band Walk tutorial
  clamshell: { en: 'O2KPabIoPPk', es: '8pzs8L7cAAs', pt: '5I8qxd06tWw' },                 // Clamshell in side-lying (AskDoctorJo)
  standing_calf_raise: { en: 'SVtg-1loH4c', es: '_R3TOH-vnF8', pt: '824pMjvGXgc' },       // Standing Calf Raise (VIDEO_MAP)
  single_leg_rdl: { en: 'J1ojvq3ftqM', es: 'yuxKoelM2Dw', pt: 'CKZVkXQitRU' },            // Single-Leg RDL tutorial
  // ── Shoulder ────────────────────────────────────────────────────────────
  cable_face_pull: { en: 'ljgqer1ZpXg', es: 'UaZPhyztYNU', pt: 'kYMTJAx_dTM' }, // Face Pull (EN/ES/PT)
  band_pull_apart: { en: 'smSSXITNpCI', es: 'R9GHzQapAL0', pt: 'ICq9SJ-BUfk' },
  scap_lateral_raise: { en: '4hTUCDUQaNA', es: 'nmiuKSO9qa8', pt: 'eU1_-JIsSg8' },        // Dumbbell Lateral Raise
  sleeper_stretch: { en: '9BN8bRVq3Xo', es: 'J2eJzztUSrQ', pt: 'b3dYmaRVSus' }, // Sleeper Stretch (EN AskDoctorJo · ES · PT)
  side_lying_external_rotation: { en: '3XLT7kpMzcM', es: 'FEkhiYRHPr0', pt: 'aHM2a24ko8o' }, // DB Side-Lying External Rotation
  wall_slide: { en: 'UB_n4DxOTCo', es: 'uxPzcxKTdlQ', pt: 'GVHu5syB-gY' },                // Scapular Wall Slides
  prone_ytw: { en: 'CFt3WjCBbpc', es: 'bIETCPwSy3M', pt: 'sOJndB-OznA' },                 // Prone W/T/Y Scapular Retraction
  scapular_pushup: { en: 'LeMk15TN0No', es: 'nrSi188vX3A', pt: 'S6MFqaj31j8' },           // Scapular Push-Ups
  doorway_pec_stretch: { en: 'M850sCj9LHQ', es: 'MBas_3lnVuE', pt: '6Be-s3RwVp4' },       // Doorway Pec Stretch (MedBridge)
  band_shoulder_dislocate: { en: '7p-Ma0eksaY', es: 'jkj4wOdRKGk', pt: 'dLWh8g3v5QE' },   // Band Shoulder Dislocates / pass-through
  // ── Elbow ───────────────────────────────────────────────────────────────
  eccentric_hammer_curl: { en: 'TwD-YGVP4Bk', es: 'RHdacbwKbTo', pt: '1-xCKLVxqqg' }, // Hammer Curl (EN/ES/PT)
  triceps_pushdown_ecc: { en: '_w-HpW70nSQ', es: 'cNa_2g-ET5g', pt: '7le1JRUUagM' },      // Cable Triceps Pushdown
  bench_dip_controlled: { en: '0326dy_-CzM', es: 'V1K9BFx9OeM', pt: 'jH9RXQjbXqs' },      // Bench Dip
  flexbar_tyler_twist: { en: 'DUfLc4n3ygg', es: '9J2UZEA5NvA', pt: 'DUfLc4n3ygg' },       // Tyler Twist (tennis elbow)
  flexbar_reverse_twist: { en: 'STHalShxKMw', es: 'aV1ET9mvG7k', pt: 'STHalShxKMw' },     // Reverse Tyler Twist (golfer's elbow)
  reverse_barbell_curl: { en: 'pXx38ZWRYjo', es: 'W2HeFyYwDPY', pt: 'jbSr9CzJPmA' },      // Reverse Curl (extensor bias)
  db_supination_pronation: { en: 'nZHS1gWMc6I', es: 'RjHOuDn5i-4', pt: 'YZFxsCPgjn8' },   // Forearm Supination/Pronation
  wrist_extensor_stretch: { en: 'Ayhu7TzNGSQ', es: 'nk594Mbtn0c', pt: '9EGl4XS1fPU' },    // Forearm Extensor Stretch
  wrist_flexor_stretch: { en: 'i-JV2PsFzWA', es: 'cyUPBCR0R9k', pt: '35UmC29q2SI' },      // Wrist Flexor Stretch (AskDoctorJo)
  eccentric_wrist_extension: { en: '0-VJoF6Y4dU', es: 'uqni-E8IifQ', pt: 'Kx8rg0MJX_c' }, // Eccentric Wrist Extension (tennis elbow)
  // ── Wrist & Hand ────────────────────────────────────────────────────────
  reverse_wrist_curl: { en: 'SfENsl5klVA', es: '-IT2RyH7QdM', pt: '27EJ1IP4heE' },        // Reverse Wrist Curl (extensors)
  wrist_extension_load: { en: 'mwlp75MS6Rg', es: 'uqni-E8IifQ', pt: 'xJIPA349wcU' },      // weight-bearing through the wrists (Front Plank)
  dead_hang: { en: 'rmdn5X_KLkY', es: '-31tCeBwPV0', pt: 'RNZEGcwmxdo' },                 // bar hang / grip (Pull-Up)
  wrist_flexor_curl: { en: 'dA9_h9r8YBw', es: 's5lhlt5FeP4', pt: 'HH7RrtPCds8' },         // Palms-Up Dumbbell Wrist Curl
  wrist_circles: { en: 'IJvS9bYl_cs', es: 'CQ71AY1w8Ls', pt: 'S1BqYYaZz3Y' }, // Wrist Circles (EN/ES/PT)
  prayer_stretch: { en: 'XnJu70SLsJk', es: 'kKvVGRe5lNA', pt: 'XnJu70SLsJk' },            // Prayer Stretch (AskDoctorJo)
  finger_extension_band: { en: 'jbs0-Z8FpDw', es: 'GBmt4qZTA1E', pt: 'e0ld034yoIA' },     // Rubber-band Finger Extension
  grip_squeeze: { en: '8h0tSMxLNG4', es: 'yDB8trR_Wv8', pt: 'lYNHkZeGJ6c' },              // Hand/Wrist Ball Squeeze (AskDoctorJo)
  radial_ulnar_deviation: { en: 'pwodoGsoIpM', es: 'p0t1XFWtx3o', pt: 'F9mdcmeGDeo' },    // Radial/Ulnar Deviation (AskDoctorJo)
  finger_tendon_glides: { en: 'grbacaaEwjg', es: 'grbacaaEwjg', pt: '42Gghqd5oWw' },      // Finger Tendon Glides (AskDoctorJo)
};
